...
public class UIBinderDemo extends Composite {
	...
	private static UIBinderDemoUiBinder uiBinder = GWT
			.create(UIBinderDemoUiBinder.class);
	...
	@UiField(provided = true)
	FormPanel exportForm = TableToExcelClientBuilder.fromTable(exportFlexTable)
			.buildExportFormWidget();

	public UIBinderDemo() {
		initWidget(uiBinder.createAndBindUi(this));
		exportPanel.setWidget(TableToExcelClientBuilder.fromTable(
				exportFlexTable).buildExportFormWidget());
